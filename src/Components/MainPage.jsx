...
function MainPage() {
  ...
  let temp = userData.currentInstitutions;
  console.log(temp);
      ...
      {userData.currentInstitutions ? (
        ...
        <div className="absolute bg-white w-screen h-screen flex flex-col justify-center items-center">
          ...
          {userData.institutions.length === 0 ? (
            ...
            <button onClick={clickHandler} className="border-[2px] mb-3 text-white hover:text-white bg-[#2B80FF] hover:bg-[#1C48C2]  duration-300 border-[#2B80FF] hover:border-[#1C48C2] py-2 px-12 group rounded-lg">
              {t("choose")}
            </button>
          )}
